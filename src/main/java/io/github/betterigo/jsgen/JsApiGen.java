...
//	private static final String DIR = "api-json";
	private static final String JS_TEMPLATE = "/*\r\n" + 
			...
			"}\r\n" + 
			"</#list>";
	public static void createJsApiFile(String jsonStr,OutputStream os) throws IOException {
...
//		config.setDirectoryForTemplateLoading(new File("fm-templates"));
		config.setTemplateLoader(createJsTemplateLoader());
		Date now = new Date();
		...
		//加载模板文件
		Template template = config.getTemplate("request-api-js");
	...
	private static TemplateLoader createJsTemplateLoader() {
		StringTemplateLoader templateLoader = new StringTemplateLoader();
		templateLoader.putTemplate("request-api-js", JS_TEMPLATE);
